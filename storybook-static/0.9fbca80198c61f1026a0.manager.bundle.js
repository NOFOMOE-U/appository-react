/*! For license information please see 0.9fbca80198c61f1026a0.manager.bundle.js.LICENSE.txt */
  ...
  [0],
  {
    309: function (module, __webpack_exports__, __webpack_require__) {
      ...
      var _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(2),
        ...
        react__WEBPACK_IMPORTED_MODULE_36___default = __webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_36__),
        _storybook_client_logger__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(11),
        _storybook_theming__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(1),
        memoizerific__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(20),
      ...
      ;(markup$1.displayName = 'markup'), (markup$1.aliases = ['html', 'mathml', 'svg', 'xml', 'ssml', 'atom', 'rss'])
      ...
      function createElement(_ref) {
        ...
        if (TagName) {
          ...
          } else props = _objectSpread({}, properties, { className: createClassNameString(properties.className) })
          var children = childrenCreator(node.children)
          return react__WEBPACK_IMPORTED_MODULE_36___default.a.createElement(
            TagName,
            Object(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.h)({ key: key }, props),
            children,
          )
        }
      }
      ...
      function DefinedInfo$2(property, attribute, mask, space) {
        var check,
          index = -1
        for (mark(this, 'space', space), Info$1.call(this, property, attribute); ++index < checksLength; )
          ...
          normal.length > 4 &&
            ...
            ('-' === value.charAt(4)
              ...
              : (value = (function datasetToAttribute(property) {
                  ...
                  ;(value = value.replace(cap$1, kebab)), '-' !== value.charAt(0) && (value = '-' + value)
                  return 'data' + value
                })(value)),
            (Type = DefinedInfo))
          ...
          function addProperty(properties, key, value) {
            ...
            null != value &&
              ...
              (properties[property] = (function parsePrimitives(info, name, value) {
                ...
                if ('object' !== _typeof(value) || !('length' in value)) return parsePrimitive(info, name, value)
      ...
      !(function (module) {
        ...
        module.exports && (module.exports = Prism),
          void 0 !== _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.C &&
      ...
      var ctx =
          'object' === ('undefined' == typeof globalThis ? 'undefined' : _typeof(globalThis))
            ...
            ? window
            : 'object' === _typeof(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.C)
            ? _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.C
            : {},
      ...
      ;(refract.highlight = function highlight(value, name) {
        ...
        if ('Object' === refract.util.type(name)) (grammar = name), (name = null)
          ...
          if (!own.call(refract.languages, name)) throw new Error('Unknown language: `' + name + '` is not registered')
        ...
        (refract.alias = function alias(name, alias) {
          ...
          for (key in map)
            for (
              length = (list = 'string' == typeof (list = map[key]) ? [list] : list).length, index = -1;
              ++index < length;
        ...
        (refract.listLanguages = function listLanguages() {
          ...
          for (language in languages)
            own.call(languages, language) && 'object' === _typeof(languages[language]) && list.push(language)
          return list
        }),
        register(markup),
        register(css),
        ...
        return function SyntaxHighlighter(_ref7) {
          var language = _ref7.language,
            ...
            rest = (function _objectWithoutProperties(source, excluded) {
              ...
              var key,
                i,
                target = Object(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.g)(source, excluded)
          ...
          if (!astGenerator)
            return react__WEBPACK_IMPORTED_MODULE_36___default.a.createElement(
              ...
              preProps,
              allLineNumbers,
              react__WEBPACK_IMPORTED_MODULE_36___default.a.createElement(CodeTag, codeTagProps, code),
            )
      ...
      var ReactSyntaxHighlighter = SyntaxHighlighter$1,
        navigator = _index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.W.navigator,
      ...
      function createCopyToClipboardFunction() {
        ...
        return (null == navigator ? void 0 : navigator.clipboard)
          ...
          : function (text) {
              return Object(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.B)(
                _this,
                void 0,
                void 0,
      ...
      var Wrapper = _storybook_theming__WEBPACK_IMPORTED_MODULE_38__.l.div(
          function (_ref10) {
            return { position: 'relative', overflow: 'hidden', color: _ref10.theme.color.defaultText }
          },
          function (_ref11) {
        ...
        SyntaxHighlighter = function SyntaxHighlighter(_a) {
          var children = _a.children,
            ...
            rest = Object(_index_681e4b07_js__WEBPACK_IMPORTED_MODULE_35__.D)(_a, [
              'children',
              'language',
              'copyable',
              'bordered',
          ...
          var highlightableCode = formatter ? formatter(format, children) : children.trim(),
            _useState2 = _slicedToArray(Object(react__WEBPACK_IMPORTED_MODULE_36__.useState)(!1), 2),
            copied = _useState2[0],
    ...
    803: function (module, exports, __webpack_require__) {
      var $ = __webpack_require__(3),
        uncurryThis = __webpack_require__(8),
        toAbsoluteIndex = __webpack_require__(130),
        ...
        { target: 'String', stat: !0, arity: 1, forced: !!$fromCodePoint && 1 != $fromCodePoint.length },
        {
          fromCodePoint: function fromCodePoint(x) {
            for (var code, elements = [], length = arguments.length, i = 0; length > i; ) {
              ...
              elements[i] =
                code < 65536 ? fromCharCode(code) : fromCharCode(55296 + ((code -= 65536) >> 10), (code % 1024) + 56320)
            }
