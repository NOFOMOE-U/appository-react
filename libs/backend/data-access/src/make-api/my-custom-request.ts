...
import { SpecificSocketType, socket } from './socket/socket'
...
export type RequestCache = {
    ...
    
  {
    ...
    //Constructor
    constructor(options: CustomRequestInit & { body?: MyContext }, userService: UserService) {
      if (!options.url) {
