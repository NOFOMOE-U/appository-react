...
import { AppConfiguration, MyContext } from '@appository/backend/context-system'
import { UserRole } from '@prisma/client'
import * as http from 'http'
import { Session } from 'inspector'
import errorMessageer from '../middleware/permissions/error-messages'
import { CustomRequest } from './custom-request'
import { CustomHeadersImpl } from '../custom-headers/custom-headers-impl'
import { MyCustomHeaders } from '../custom-headers/my-custom-headers'
import { BodyContent, CustomRequestOptions } from './custom-request-init'  
import { CustomRequestWithContext, YourRequestObject } from './custom-request-with-context'  
...
import { SessionData } from 'libs/backend/data-access/src/types/express';
// 'data - access / src / middleware / permissions / error - messages
...
export class MyCustomRequest<T extends MyContext<UserWithoutSensitiveData>> extends Request {
  ...
  currentUser?: UserWithAccessToken | undefined
  //Constructor
  constructor(
    ...
    const requestContext: CustomRequestWithContext<LocalMyContext> = {
      ...
      accessToken: '',
      prisma: undefined,
      request: {} as CustomRequest<unknown>,
      token: '',
      rawHeaders: [],
      session: {
        userId: '',
      ...
      cookies: {},
      req: {} as Request<ParamsDictionary, any, any, ParsedQs, Record<string, any>>,
  ...
  setAuthenticatedUser(user: UserWithAccessToken) {
